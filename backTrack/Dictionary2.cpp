// Tim cac tu trong tu dien co the tao ra tu ma tran ky tu
#include<bits/stdc++.h> 
using namespace std;   
// chuyen cac ky tu sang in hoa
#define char_int(c) ((int)c - (int)'A')   
// tat ca cac ky tu Alphabet size 
#define SIZE (26)   
#define M 3 
#define N 3 
struct TrieNode { //dinh nghia mot node tren cay
    TrieNode *Child[SIZE];   
    bool leaf; //no la la neu ket thuc mot tu
}; 
  
// tra lai mot node moi 
TrieNode *getNode() { 
