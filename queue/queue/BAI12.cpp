//thoi gian toi thieu de cam hong
#include<bits/stdc++.h> 
#define MAX 101 
int R, C, A[MAX][MAX]; 
using namespace std; 
bool isvalid(int i, int j) { //kiem tra o o trong hay ngoai
    return (i >= 0 && j >= 0 && i < R && j < C); 
}   
struct ele { //cau truc mo o
    int x, y; 
};   
...
int rotOranges(void) {     
    ...
    // Return -1 if all Aanges could not rot, otherwise -1. 
